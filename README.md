...
# Cartesi Werewolf Example

The Cartesi Werewolf Example is based on the Cartesi Rollups Examples. Please navigate to [Werewolf Example README](werewolf) for more about the project.
